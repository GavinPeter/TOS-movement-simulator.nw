...
var BallSelectScene = function(elementId){
  ...
  this.draw = function(){
    ...
    if(self.invalidate){
      ...
      ctx.drawImage(ImageResource.BALL_GREEN, BALL_SIZE * 1 + MARGINE, MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
      ctx.drawImage(ImageResource.BALL_BLUE, BALL_SIZE * 2 + MARGINE, MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
      ...
      //ctx.drawImage(ImageResource.BALL_POISON, BALL_SIZE * 0 + MARGINE, BALL_SIZE * 1 + MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
      //ctx.drawImage(ImageResource.BALL_OZYAMA, BALL_SIZE * 1 + MARGINE, BALL_SIZE * 1 + MARGINE, BALL_SIZE - MARGINE * 2, BALL_SIZE - MARGINE * 2);
      // 枠線描画
